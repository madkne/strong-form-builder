...
export type FileUploaderFileUploadedEventCallback = (file: FileUploaderFileStruct, event: any, self?: StrongFBFileUploaderWidget) => any;
...
export type FileUploaderServerSendFileType<R = any> = (file: File) => any;
