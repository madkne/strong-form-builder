...
export type StrongFBBaseLayoutBuilderSchema<WIDGET extends string = string> = Omit<StrongFBLayoutBuilderSchema<WIDGET>, 'layouts' | 'widgets' | 'widgetHeaders'>;

export type StrongFBLayoutBuilderType = 'box' | 'grid';

export type StrongFBLayoutBuilderGridColumnType = 'col-1' | 'col-2' | 'col-3' | 'col-4' | 'col-5' | 'col-6' | 'col-7' | 'col-8' | 'col-9' | 'col-10' | 'col-11' | 'col-12' | 'col-auto' | 'col-full';